...
bulat_skin_equipped = False
amount_of_cookies = 0
is_bulat_skin_obtained = False

with open('data.json', 'r+') as file:
    dataa = json.load(file)

if dataa["bulat_skin_equipped"] == True:
    enemy_images = {
        "weak": pg.image.load("assets/images/enemies/enemy_5.png").convert_alpha(),
        "medium": pg.image.load("assets/images/enemies/enemy_6.png").convert_alpha(),
        "strong": pg.image.load("assets/images/enemies/enemy_7.png").convert_alpha(),
        "elite": pg.image.load("assets/images/enemies/enemy_8.png").convert_alpha()
    }
else:
    enemy_images = {
...
if dataa["bulat_skin_equipped"] == True:
    for x in range(1, c.TURRET_LEVELS + 1):
        turret_sheet = pg.image.load(f'assets/images/turrets/bulat_{x}.png').convert_alpha()
        turret_spritesheets.append(turret_sheet)
    cursor_turret = pg.image.load("assets/images/turrets/bulat_turret_cursor.png").convert_alpha()
else:
    for x in range(1, c.TURRET_LEVELS + 1):
...
bulat_enemy_image = pg.image.load("assets/images/enemies/enemy_5.png").convert_alpha()
...
def display_data():
    # draw panel
    pg.draw.rect(screen, (255,255,255), (c.SCREEN_WIDTH, 0, c.SIDE_PANEL, c.SCREEN_HEIGHT))
    pg.draw.rect(screen, (255,255,255), (c.SCREEN_WIDTH, 0, c.SIDE_PANEL, 400), 2)
    screen.blit(logo_image, (c.SCREEN_WIDTH, 400))
    # display data
    draw_text("WAVE: " + str(world.level), text_font, (0,0,0), c.SCREEN_WIDTH + 10, 10)
    screen.blit(heart_image, (c.SCREEN_WIDTH + 10, 35))
    draw_text(str(world.health), text_font, (0,0,0), c.SCREEN_WIDTH + 50, 40)
    screen.blit(coin_image, (c.SCREEN_WIDTH + 10, 65))
    draw_text(str(world.money), text_font, (0,0,0), c.SCREEN_WIDTH + 50, 70)
...
def main_game_cycle():
    ...
    while run:
        ...
        if game_over == False:
            ...
            draw_text(str(c.BUY_COST), text_font, (0,0,0), c.SCREEN_WIDTH + 215, 135)
            ...
            if selected_turret:
                ...
                if selected_turret.upgrade_level < c.TURRET_LEVELS:
                    ...
                    draw_text(str(c.UPGRADE_COST), text_font, (0,0,0), c.SCREEN_WIDTH + 215, 195)
